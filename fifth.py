...
# definice úvodních binárních sekvencí obrázkových souborů     s
...
def is_gif(file_name):
    ...
    if header == gif_header1:
        return True
    elif header == gif_header2:
        return True
    else:
        return False
